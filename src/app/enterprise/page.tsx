...
const EnterpriseFeatures = [
  ...
  {
    icon: <BarChart3 className="w-8 h-8 text-sky-700" />,
  ...
  {
    icon: <HeadphonesIcon className="w-8 h-8 text-sky-700" />,
...
export default function EnterpriseSolutionsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-gray-900 overflow-hidden font-sans">
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-6 py-8">
          <Link href="/" className="inline-flex items-center text-sm font-medium text-gray-400 hover:text-gray-900 transition-colors">
        ...
        <section className="container mx-auto px-6 pt-12 pb-24 lg:pt-24 lg:pb-32">
          <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] border border-gray-100 mb-8 backdrop-blur-md">
              <span className="w-2 h-2 rounded-full bg-[#b4e6ff] animate-pulse" />
              <span className="text-sm font-medium tracking-wide text-sky-700">OCCUPYO FOR ENTERPRISE</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link 
                href="/sign-in" 
                className="flex items-center justify-center gap-2 bg-gray-50 border border-gray-100 text-gray-900 px-6 py-3 md:px-8 md:py-4 rounded-full font-semibold hover:bg-gray-100 active:scale-95 transition-all duration-300 backdrop-blur-sm w-full sm:w-auto"
              >
                Sign In to Portal
              </Link>
            </div>
        ...
        <section className="border-y border-gray-100 bg-white/[0.01] backdrop-blur-3xl relative">
          ...
          <div className="container mx-auto px-6 py-24">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {EnterpriseFeatures.map((feature, idx) => (
                <div 
                  key={idx}
                  className="group bg-white/[0.03] border border-white/5 rounded-3xl p-8 hover:bg-white/[0.05] hover:border-gray-100 transition-all duration-500 hover:-translate-y-1 shadow-[0_0_0_rgba(0,0,0,0)] hover:shadow-[0_20px_40px_-20px_rgba(180,230,255,0.15)]"
                  style={{
                ...
                >
                  <div className="bg-gray-50 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                    {feature.icon}
                  </div>
        ...
        <section className="container mx-auto px-6 py-24">
          <div className="bg-gradient-to-br from-white/[0.05] to-transparent border border-gray-100 rounded-[3rem] p-8 md:p-16 relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
              <div>
                ...
                <Link 
                  ...
                  className="inline-flex items-center text-sky-700 font-semibold hover:text-gray-900 transition-colors"
                >
              ...
              <div className="relative">
                <div className="aspect-square rounded-3xl bg-black/50 border border-gray-100 backdrop-blur-xl p-6 shadow-2xl relative">
                  ...
                  <div className="space-y-4 font-mono text-sm">
                    ...
                    <div className="pl-4 text-sky-700">portfolio(id: "ent_xyz") {'{'}</div>
                    <div className="pl-8 text-gray-500">totalSqft</div>
                    <div className="pl-8 text-gray-500">activeLeases</div>
                    <div className="pl-8 text-gray-500">utilizationRate</div>
                    <div className="pl-4 text-sky-700">{'}'}</div>
                    <div className="text-[#cbb4ff]">{'}'}</div>
                  </div>
                  
                  {/* Floating Elements */}
                  <div className="absolute -right-8 top-1/4 bg-gray-100 backdrop-blur-xl border border-gray-200 p-4 rounded-2xl animate-bounce" style={{ animationDuration: '4s' }}>
                    <div className="text-xs text-gray-400 mb-1">Utilization</div>
                    <div className="text-xl font-bold text-green-400">94.2%</div>
                  </div>
                  <div className="absolute -left-8 bottom-1/4 bg-gray-100 backdrop-blur-xl border border-gray-200 p-4 rounded-2xl animate-bounce" style={{ animationDuration: '5s', animationDelay: '1s' }}>
                    <div className="text-xs text-gray-400 mb-1">Active Space</div>
                    <div className="text-xl font-bold text-sky-700">2.4M sqft</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="container mx-auto px-6 py-24 text-center">
          ...
          <div className="relative inline-block group">
            ...
            <Link 
              href="mailto:sales@occupyo.com" 
              className="relative flex items-center gap-3 bg-black text-white border border-gray-200 px-10 py-5 rounded-full font-bold text-lg hover:bg-white hover:text-black transition-all duration-300"
            >
