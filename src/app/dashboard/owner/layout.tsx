    ...
    <div className="min-h-screen bg-[var(--background)] flex flex-col md:flex-row relative">
      ...
      `}>
        ...
        <nav className="flex-1 p-4 space-y-1">
          <Link onClick={() => setIsMobileMenuOpen(false)} href="/dashboard/owner" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-xl text-gray-900 bg-black/5 hover:bg-black/10 transition-colors">
