...
export function HeroCarousel() {
  ...
  return (
    <>
      ...
      {/* Bottom fade to blend seamlessly into the page background without tinting the main image */}
      <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-[#FAFAF7] to-transparent z-[1] pointer-events-none" />
    </>
  );
}
